(function() {
        ...
        if (nome.includes('assistência') || nome.includes('social')) {
            ...
            html += `
                <a href="https://luzdoamanha.org.br/biblioteca/" target="_blank" class="m-app-card">
                    ...
                    <div class="m-app-name">Acessar Biblioteca</div>
                </a>
            `;
    ...
    function configurarMenuSubindo() {
        ...
        const isIrradiacao = (estruturaAtual.nome || '').toLowerCase().includes('irradia') || (estruturaAtual.nome || '').toLowerCase().includes('sela');
        const isAssistencia = (estruturaAtual.nome || '').toLowerCase().includes('assist') && (estruturaAtual.nome || '').toLowerCase().includes('social');
        const isAtendimento = (estruturaAtual.nome || '').toLowerCase().includes('atendimento');

        const config = estruturaAtual.abas_config || {
        ...
        sheetContent.innerHTML = menuHtml;
    }
